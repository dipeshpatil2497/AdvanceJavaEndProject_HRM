...
<script
	...
	crossorigin="anonymous"></script>
<title>Request Student List</title>
</head>
<body>
	<div class="container-fluid"
		...
		<div class="row justify-content-center">
			<div class="col-10 mt-5">
				<h2 align="center" class="text-light">Request Student List</h2>
				<table class="table table-striped text-light">
					<thead>
						<tr class="font-weight-bold" style="font-size: 3vh">
							...
							<td>PinCode</td>
							<td>Status</td>
							<td class="pl-5">Action</td>

						</tr>
					</thead>
					<tbody>
						<%
							List<Student> reqlist = (List<Student>) request.getAttribute("reqlist");
						for (Student slist : reqlist) {
						%>
						<tr>
							...
							<td><a class="btn btn-success w-20" href="con_stud_req.htm?studId=<%=slist.getStudId()%>">
									Confirm </a>&nbsp; &nbsp;
							<a class="btn btn-danger w-20" href="rej_stud_req.htm?studId=<%=slist.getUserId()%>">
									Reject </a></td>
						</tr>
						<%
							}
				...
				<div class="row justify-content-between align-items-center mt-5">
					...
					<div class="col-5 d-flex justify-content-end align-items-center">
						<a class="btn btn-info w-50 " href="home_admin.jsp">Back to Home</a>
					</div>
				</div>
