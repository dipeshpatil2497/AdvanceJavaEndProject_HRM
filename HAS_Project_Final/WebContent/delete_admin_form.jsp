...
<title>Deleting Admin Page</title>
<!-- CSS -->
<link rel="stylesheet"
...
<body>
	...
	<div class="container-fluid d-flex justify-content-center"
		...
		<spr:form action="delete_admin.htm" class="w-50 mt-5" method="post">
			<table align="center" class="table table-striped mt-5">
				<thead class="text-light">

					<tr class="text-center" style="font-weight: bold">
						<th colspan="2"><h3>Delete Admin </h3></th>
					</tr>
				</thead>
				<tbody class="text-light">
				<tr>
					<td>Enter UserId :</td>
					<td><input name="userid" class="form-control" required="true" /></td>
				</tr>
				<tr>
					<td><a class="btn btn-primary w-50 " href="admin_profile.jsp">Back</a></td>
					<td><input type="submit" class="btn btn-success w-50 " required="true" value="Submit"></td>
				</tr>
				</tbody>
			</table>
		</spr:form>
